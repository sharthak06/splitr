...
export const TESTIMONIALS = [
  {
    quote:
        "finally stopped getting confused about who paid for what!",
    name: "Sarah K",
    image: "/logos/testinomial2.png",
    role: "Rental Property Manager",
  },
  {
    quote:
      "Splitr's calculations are so accurate,Our group vacation was financially stress-free thanks to Splitr",
    name: "John",
    image: "/logos/testinomial3.png",
    role: "Stock Market Expert",
  },
  {
    quote:
      "This app saved our sanity. No more arguments over bills, just simple, fair tracking",
    name: "David",
    image: "/logos/testinomial1.png",
    role: "Job Searcher",
  },
];